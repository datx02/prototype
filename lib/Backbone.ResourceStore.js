...
module.exports = (function(root) {
  ...
  _.extend(Backbone.ResourceStore.prototype, {
    ...
    update: function(model) {
      throw "Updating resources aren't supported as of now";
    },

    destroy: function(model) {
      throw "Destroying resources aren't supported as of now";
    },

    create: function(model) {
      var author = App.rymdNode.currentIdentity() || 'Anonymous';
