module.exports = Backbone.View.extend({
  ...
  addFiles: function(files) {
    ...
    // data store itself.
    App.rymdNode.store.createResource(files.name, files, App.rymdNode.currentIdentity() || 'Anonymous', files.type)
      .then(App.rymdNode.store.saveResource.bind(App.rymdNode.store))
