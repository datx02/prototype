module.exports = Backbone.View.extend({
  ...
  addFiles: function(files) {
    ...
    App.rymdNode.store.createResource(files.name, files, App.identity || 'Anonymous', files.type).then(App.rymdNode.store.saveResource.bind(App.rymdNode.store)).then(function(records) {
